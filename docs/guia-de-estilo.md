...
Recortes de projetos reais devem manter a composição, proporções de mídia, vocabulário visual e comportamento do projeto de origem. Eles recebem uma identificação explícita do cliente/projeto e não podem ser substituídos por avatares, fotografias ou conteúdos genéricos. Retratos usam recorte limpo; degradês servem apenas ao contraste localizado de texto e não devem apagar rosto, ombros ou bordas da fotografia.
